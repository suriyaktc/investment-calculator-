...
# Detect if running on a cloud server (Render sets IS_CLOUD=true,
# or we detect by absence of a display / TERM)
IS_CLOUD = os.environ.get("IS_CLOUD", "false").lower() == "true" or \
